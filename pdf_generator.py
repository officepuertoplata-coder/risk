...
def generate_pdf(data: Dict[str, Any]) -> bytes:
    ...
    pdf.set_draw_color(*CYAN)
    pdf.set_line_width(0.4)
    pdf.rect(16, fta_y, 178, 28, "FD")
    pdf.set_line_width(0.2)
    pdf.set_fill_color(*CYAN)
    pdf.rect(16, fta_y, 4, 28, "F")
    ...
    pdf.cell(0, 5, "office@sw-tech.net", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
    pdf.set_x(24)
    pdf.set_font("Helvetica", "", 8)
    pdf.set_text_color(*MGRAY)
    pdf.cell(0, 5, "cal.com/alexander-zajic/riskmanagement  |  Software Technologies - SSOT Supplier Risk Management")
